...
<div class="nht-main">
	<div class="nht-billboard nht-billboard--live-search">
		<div class="nht-container">
			<form class="nht-live-search__searchbox">
				<input type="text" class="nht-live-search__input" id="nhtLiveSearchInput" autocomplete="off" placeholder="Search"></input>
	...
	<div class="nht-container">
		<div class="nht-live-search">
			<div class="nht-live-search__results">
				<div class="nht-live-search__section" search-section="stories" style="display: none">
					<div class="nht-live-search__title">Stories</div>
					<div class="nht-row nht-row--three-by nht-row--live-search" search-results="stories">
					</div>
				</div>
				<div class="nht-live-search__section" search-section="issues" style="display: none">
					<div class="nht-live-search__title">Issues</div>
					<div class="nht-row nht-row--three-by nht-row--live-search" search-results="issues">
					</div>
				</div>
				<div class="nht-live-search__section" search-section="staff" style="display: none">
					<div class="nht-live-search__title">Staff</div>
					<div class="nht-row nht-row--three-by nht-row--live-search" search-results="staff">
					</div>
				</div>
			</div>
